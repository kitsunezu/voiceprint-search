...
- Portainer redeploy can outlast Cloudflare's request timeout; the workflow treats HTTP `504` from the redeploy call as a warning after the request reaches Portainer.
